...
st.set_page_config(page_title="This chatbot will answer questions about SJSU's Artistic Excellence Programming Grants", page_icon="🦙", layout="centered", initial_sidebar_state="auto", menu_items=None)
st.title("Ask questions about any part of the AEPG process, the rules of th program, and how to apply")
